...
public class ProfessionSubVO extends ProfessionsCleaningVO {
	...
	private int pDoor;
	private int pTrash;
	private int pTransportaition;
	private int pOneroom;
	private int pKeep;
	
	
	public int getpTransportaition() {
		return pTransportaition;
	}
	public void setpTransportaition(int pTransportaition) {
		this.pTransportaition = pTransportaition;
	}
