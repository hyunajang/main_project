	...
	<div id="contents">
		...
		<div id="updateForm">
			<form action="t_updateBoard.do" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
		     			<label for="tAddress">장소</label>
		    			<input type="text" class="form-control" id="tAddress" name="tAddress" value="${Board.tAddress}">
		  			</div>
						
					<div class="form-group">
		     			<label for="tAddress">날짜</label>
		    			<input type="date" class="form-control" id="tJoinDate" name="tJoinDate" value="${Board.tJoinDate}">
		  			</div>
