                    ...
                    <div id="pro-mypage-content">
                        <div id="pro-mypage-profile">
                            ...
                            <div class="pro-mypage-info">
                                <div class="pro-info-list service-section">
                                    <div class="subsection">
                                        ...
                                        <div class="info-content">
                                            ...
                                            <div class="content1"><span class="category-text">서비스01</span>
                                                                 <span class="category-text">서비스02</span></div>
                                        </div>
                                    </div>
                                    <div class="subsection">
                                        <div class="info-content">
                                            <div class="content1"><span class="subtitle-text">증명서 등록</span></div>
                                            <img class="file-image" src="/resources/image/${professionProfile.certification}"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="pro-info-btn">
                                    <input type="button" value="수정 하기" class="propage-btn" onclick="location.href='updateProfile.do'"/>
