                ...
                <div id="user-mypage-content">
                   ...
                   <!-- 사진 업로드
                        <div id="user-mypage-thumb">  
                          <img id="thumb-img" >
                            <a href="uploadUserPic.do"><label class="click-icon" for="user-thumb"><i class="fas fa-camera"></i></label> 
                             <input type="file" name="uploadFile" id="user-thumb" class="upload-box upload-plus" accept="image/*" onchange="thumbnail(event)"></a>                      	
                        </div>
                         -->
