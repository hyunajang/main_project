	  ...
	  <div class="collapse navbar-collapse" id="t_navbar2">
	    <ul class="navbar-nav mr-auto">
	      <li class="nav-item active" class="t_navbar-items">
	        <a class="nav-link" href="t_getBoardList.do?같이먹어요">같이 먹어요
	          <span class="sr-only">(current)</span>
	        </a>
	      </li>
	      <li class="nav-item">
	        <a class="nav-link" href="t_getBoardList.do">같이 출퇴근해요</a>
	      </li>
	      <li class="nav-item">
	        <a class="nav-link" href="t_getBoardList.do">같이 나눠요</a>
	      </li>
	      <li>
	...
	<div id="t_contents">
		...
		<div>
			<a href="t_getWritingBoard.do">
				<button type="submit" id="heayo_writing_btn" >글 작성</button>
			</a>
		</div>
		<c:forEach var="board" items="${boardList}">
			<div id="t_content">
				<div id="tAddress_Bookmark">
					<div id="tAddress">${board.tAddress}</div>
					<div id="tBookmark" onclick="tBookmark(${board.tNo},${board.tBookmark})">${board.tBookmark}</div>
				</div>
				<div>
					<a href="t_getBoard.do?tNo=${board.tNo}">
						<img src="/WEB-INF/boardImages/${board.tPic}" height="250" width="250">
					</a>
				</div>
